"""
Modelo de previsão de atrasos usando Machine Learning
Treina modelo para prever quais empréstimos ficarão atrasados
"""
import pandas as pd
import numpy as np
...
class DelayPredictor:
    """Prediz atrasos em empréstimos usando ML"""
    ...
    def prepare_dataset(self):
        ...
        # Calcular taxa de atraso histórica
    ...
    def predict_loan(self, id_usuario, dias_duracao, mes_retirada, dia_semana, 
        ...
        """Prediz se um empréstimo será atrasado"""
